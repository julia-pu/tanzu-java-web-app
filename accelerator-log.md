...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=julia-pu&repo=tanzu-java-web-app",
  "projectName" : "tanzu-java-web-app",
  "repositoryPrefix" : "gcr.io/cf-osl-open-source-licensing/julia-test"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->gcr.io/cf-osl-open-s...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=julia-pu&repo=tanzu-java-web-app'
